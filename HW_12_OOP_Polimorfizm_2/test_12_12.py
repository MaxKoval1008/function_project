class Pet:
    ...
    @classmethod  #декоратор позволяющий обращаться к той же функции в рамках этого класса
    def get_counter(cls): #метод вывода приватного значения counter
        return print(cls.__counter)
